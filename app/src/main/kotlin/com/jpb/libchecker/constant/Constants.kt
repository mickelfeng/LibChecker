...
object Constants {
  ...
  const val ACTION_APP_LIST = "com.jpb.libchecker.intent.action.START_APP_LIST"
  const val ACTION_STATISTICS = "com.jpb.libchecker.intent.action.START_STATISTICS"
  const val ACTION_SNAPSHOT = "com.jpb.libchecker.intent.action.START_SNAPSHOT"
