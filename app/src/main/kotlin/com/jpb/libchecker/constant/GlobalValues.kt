...
import com.jpb.libchecker.utils.SPDelegates
import com.jpb.libchecker.utils.SPUtils
...
object GlobalValues {
  ...
  val isAnonymousAnalyticsEnabled: MutableLiveData<Boolean> =
    MutableLiveData(getPreferences().getBoolean(Constants.PREF_ANONYMOUS_ANALYTICS, false))
