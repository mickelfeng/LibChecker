...
import com.jpb.libchecker.annotation.ALL
...
import com.jpb.libchecker.annotation.STATIC
import com.jpb.libchecker.bean.DetailExtraBean
import com.jpb.libchecker.bean.FeatureItem
import com.jpb.libchecker.constant.AbilityType
...
import com.jpb.libchecker.databinding.ActivityAppDetailBinding
import com.jpb.libchecker.recyclerview.adapter.detail.FeatureAdapter
import com.jpb.libchecker.ui.fragment.detail.AppBundleBottomSheetDialogFragment
import com.jpb.libchecker.ui.fragment.detail.AppInfoBottomSheetDialogFragment
import com.jpb.libchecker.ui.fragment.detail.MODE_SORT_BY_LIB
import com.jpb.libchecker.ui.fragment.detail.MODE_SORT_BY_SIZE
import com.jpb.libchecker.ui.fragment.detail.impl.AbilityAnalysisFragment
import com.jpb.libchecker.ui.fragment.detail.impl.ComponentsAnalysisFragment
import com.jpb.libchecker.ui.fragment.detail.impl.DexAnalysisFragment
import com.jpb.libchecker.ui.fragment.detail.impl.MetaDataAnalysisFragment
import com.jpb.libchecker.ui.fragment.detail.impl.NativeAnalysisFragment
import com.jpb.libchecker.ui.fragment.detail.impl.PermissionAnalysisFragment
import com.jpb.libchecker.ui.fragment.detail.impl.StaticAnalysisFragment
...
import com.jpb.libchecker.utils.PackageUtils.isPWA
import com.jpb.libchecker.utils.PackageUtils.isPlayAppSigning
import com.jpb.libchecker.utils.PackageUtils.isXposedModule
import com.jpb.libchecker.utils.Toasty
import com.jpb.libchecker.utils.extensions.getDrawable
import com.jpb.libchecker.utils.extensions.isOrientationPortrait
import com.jpb.libchecker.utils.extensions.unsafeLazy
import com.jpb.libchecker.utils.harmony.ApplicationDelegate
